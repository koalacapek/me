...
<div className="flex gap-4 justify-center">
  <img src="me1.jpg" alt="Photo 1" className="w-1/2 rounded-md" />
  <img src="me2.jpg" alt="Photo 2" className="w-1/2 rounded-md" />
</div>
...
- Finally graduated!
- Help developing main website for [Gloom Studio](https://www.linkedin.com/company/gloom-studios/), a software development consulting.
