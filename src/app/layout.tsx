      ...
      >
        <ViewTransition>
          <main className="h-fit max-h-screen">
            <div className="relative mx-auto h-fit w-screen [&>article]:mx-auto px-10 pt-10 pb-10 md:max-w-md md:pb-24 md:pt-24 lg:max-w-xl lg:pb-24 xl:max-w-2xl xl:pb-24">
              <Navbar />
              {children}
            </div>
          </main>
